...
def gather_20newsgroups_data():
    path = '../Session 1/Data/20news-bydate.tar/20news-bydate/'
    dirs = [path+dir_name+'/' 
    ...
    list_newgroups.sort()
    with open('../Session 1/Data/20news-bydate.tar/20news-bydate/stop_words.txt') as f:
    ...
    with open('../Session 1/datasets/20news-train-processed.txt','w') as f:
        f.write('\n'.join(train_data))
    with open('../Session 1/datasets/20news-test-processed.txt','w') as f:
        f.write('\n'.join(test_data))
    with open('../Session 1/datasets/20news-full-processed.txt','w') as f:
        f.write('\n'.join(full_data))
...
def generate_vocabulary(data_path):
    ...
    with open('../Session 1/datasets/words_idfs.txt','w') as f:
        f.write('\n'.join(word + '<fff>' + str(idf) for word,idf in word_idfs))


def get_tf_idf(data_path):
    with open('../Session 1/datasets/words_idfs.txt') as f:
